...
##SBATCH -t 1:00:00
#SBATCH -J cnvgatk
#SBATCH --error /proj/naiss2024-23-57/ICR_male_lineage/GBS_violeta/log_files/cnv_random_cohort_mode.gatk.err
#SBATCH --output /proj/naiss2024-23-57/ICR_male_lineage/GBS_violeta/log_files/cnv_random_cohort_mode.gatk.out
...
gatk GermlineCNVCaller --contig-ploidy-calls $output_folder/random_cohort-calls \
        --run-mode COHORT \
        --intervals filtered_gatk_mm39_bins.interval_list \
        --interval-merging-rule OVERLAPPING_ONLY \
        --output $output_folder \
        --output-prefix random_model_cnv_caller_GATK \
