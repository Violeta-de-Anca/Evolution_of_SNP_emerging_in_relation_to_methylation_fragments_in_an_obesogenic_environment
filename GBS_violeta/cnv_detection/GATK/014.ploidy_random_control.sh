...
##SBATCH -t 1:00:00
#SBATCH -J ploidygatk
#SBATCH --error /proj/naiss2024-23-57/ICR_male_lineage/GBS_violeta/log_files/ploidy_random_cohort_mode.gatk.err
#SBATCH --output /proj/naiss2024-23-57/ICR_male_lineage/GBS_violeta/log_files/ploidy_random_cohort_mode.gatk.out
...
gatk DetermineGermlineContigPloidy --output $output_folder --output-prefix random_cohort --contig-ploidy-priors $output_folder/contig_prior_table_mm39.tsv --interval-merging-rule OVERLAPPING_ONLY \
